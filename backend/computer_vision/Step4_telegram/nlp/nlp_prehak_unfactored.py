...
def init_nlp():
    ...
    global vectorizer
    global nlp
    recipes = pd.read_pickle('C:\\Users\\ijzep\\_AI_\\CAPSTONE\\GIT_project\\Recipix\\backend\\computer_vision\\Step4_telegram\\nlp\\preprocessed_recipes.pkl')
    ...
    recipes = pd.read_csv('C:\\Users\\ijzep\\_AI_\CAPSTONE\\GIT_project\\Recipix\\backend\\computer_vision\\Step4_telegram\\nlp\\tagged_recipes_df.csv')
    ...
    tokenized_text = pd.read_csv('C:\\Users\\ijzep\\_AI_\CAPSTONE\\GIT_project\\Recipix\\backend\\computer_vision\\Step4_telegram\\nlp\\tokenized_text.csv')
